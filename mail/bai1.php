<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
		    ...
		    $matkhau = ' oejx rcab ylxc vwqa';// mật khẩu của tài khoản ngolequanvh@gmail.com
		    $tennguoigui = 'hieuvipprono1';
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $noidungthu = "<b>Chào bạn toi la hieuvippro!</b><br>Chúc an lành!" ;
